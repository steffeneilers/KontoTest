...
public class Girokonto extends Konto {
  ...
  public void einzahlen(double betrag) {
    if (betrag>0) {
      ...
      System.out.println("Beträge unter 0 Euro sind nicht einzahlbar");
    } // end of if-else
  }
  ...
  public void auszahlen(double betrag) {
    if (betrag>0) {
      ...
      if ((kontostandNeu*-1)>dispoLimit) {
        System.out.println("Auszahlung würde das Dispo-Limit überschreiten und wird daher nicht ausgeführt");
      } else {
        kontostand=kontostandNeu;
        System.out.println(betrag+" Euro ausgezahlt");
      } // end of if-else
    } else {
      System.out.println("Beträge unter 0 Euro sind nicht auszahlbar");
    } // end of if-else
  }
